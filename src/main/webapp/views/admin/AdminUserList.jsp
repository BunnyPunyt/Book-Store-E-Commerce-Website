			...
			<div class="col-12">
				<div class="row p-0 m-0">
					...
					<div class="col-12 m-0" style="background-color: #e1e0e0;">
							...
							<div class="p-1">
								<button class="btn btn-info ">
									<a class="text-decoration-none text-dark"
										href="${pageContext.request.contextPath}/user/add">Add new User</a>
								</button>
							</div>
						</div>
										...
										<td>
											<button class="btn btn-primary ">
												<a class="text-decoration-none text-light"
													href="${pageContext.request.contextPath}/user/edit?id=${user.maND}">Edit</a>
											</button> | 
											<button class="btn btn-danger ">
												<a class="text-decoration-none text-light"
													href="${pageContext.request.contextPath}/user/delete?id=${user.maND}">Delete</a>
											</button>
						...
						<a href="${pageContext.request.contextPath}/userList/export" class="btn btn-primary">Export to Excel</a>
