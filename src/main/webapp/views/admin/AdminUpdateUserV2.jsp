							...
							<form class="${pageContext.request.contextPath}/user/edit row" method="POST">
										...
										<tbody>
											<c:forEach items="${addresses}" var="address">
												<tr>
													...
													<td><a
														href="${pageContext.request.contextPath}/address/edit?maDC=${address.maDC}"
														class="btn btn-primary">Edit</a> <a
														href="${pageContext.request.contextPath}/address/delete?maDC=${address.maDC}"
								...
								<div class="edit-form-container">
									...
									<form
										...
										method="POST">
										<div class="mb-3">
											<label class="form-label">Address ID</label> <input
												type="text" class="form-control" name="maDC"
												value="${address.maDC}" readonly>
										</div>
										<div class="mb-3">
									...
									<a href="${pageContext.request.contextPath}/address/add?userId=${user.maND}"
