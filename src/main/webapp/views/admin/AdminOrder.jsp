    ...
    <div class="row  p-0 m-0">
        <div class="col-2" style="background-color: #379ab1; ">
            <div class=" " style="padding-top:80px; padding-left: 60px;"><a href="#1"
                    ...
                    Dashboard</a></div>
            <div class=" " style="padding-top:50px; padding-left: 60px;"><a href="#2"
                    style="color:aliceblue; font-size: large;text-decoration: none"><i class='bx bx-user'></i> Người
                    dùng</a></div>
            <div class=" " style="padding-top:50px; padding-left: 60px;"><a href="#3"
            ...
            <div class="col-12">
                <div class="row p-0 m-0">
                    ...
                    <div class="col-12 m-0" style="background-color: #e1e0e0; ">
                        <h2 style="border-bottom: 1px grey;">Thông tin đơn hàng</h2>
                        <table class="table">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
