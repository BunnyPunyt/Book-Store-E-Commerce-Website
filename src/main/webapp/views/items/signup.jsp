				...
				<div class="bg-white p-0">
					<div class="  mt-2 pt-2 pb-2 ">
						<a href="#" class="text-decoration-none pe-5 ps-5 col-6 active ">Đăng
							Ký</a> <a href="#" class="text-decoration-none pe-5 ps-5 col-6 ">Đăng
							Nhập</a>
					</div>
					<div class="pt-3 mb-2 align-items-center position-relative "
							...
							<div class="col-6">
								...
								<div class="search-input">
									<div class="input-group input-group-sm ">
										<input type="password"
											class="form-control border-2 border-danger"
											style="height: 2rem;" placeholder="Nhập Mật Khẩu">
									</div>
								</div>
							</div>
						</div>
						<div class="row mt-2">
							<div class="col-6">
								<div>
									<span class="d-block text-start">Xác Nhận Mật Khẩu</span>
								</div>
								<div class="search-input">
									<div class="input-group input-group-sm ">
										<input type="password"
											class="form-control border-2 border-danger"
											style="height: 2rem;" placeholder="Xác Nhận Mật Khẩu">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="mt-4 mb-3 ">
						<a href="#" class=" fw-bold rounded-2 p-2"
							style="color: #C92127; border: #C92127 solid 2px; text-decoration: none;">Đăng
							Ký</a>
					</div>
				</div>
